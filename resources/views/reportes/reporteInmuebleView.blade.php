                            ...
                            <form action="{{ route('reporteD') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                                                <label class="col-form-label col-md-12 col-sm-12 label-align" for="desde">Desde :
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                                                <label class="col-form-label col-md-12 col-sm-12 label-align" for="hasta">Hasta :
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                                            <button type="submit" target="_blank" class="btn btn-primary">Generar</button>
                                        </div>
                                    </div>
                                </div>
